...
- (void)setScanView
{
    _scanView = [[UIView alloc] initWithFrame:CGRectMake(0,0, rect.size.width, rect.size.height)];
    _scanView.backgroundColor=[UIColor clearColor];
    
    //    //最上部view
    UIView* upView = [[UIView alloc] initWithFrame:CGRectMake(0,0, rect.size.width,SCANVIEW_EdgeTop)];
    upView.alpha =TINTCOLOR_ALPHA;
    upView.backgroundColor = [UIColor blackColor];
    [_scanView addSubview:upView];
    
    //左侧的view
    UIView *leftView = [[UIView alloc] initWithFrame:CGRectMake(0,SCANVIEW_EdgeTop, SCANVIEW_EdgeLeft,rect.size.width-2*SCANVIEW_EdgeLeft)];
    leftView.alpha =TINTCOLOR_ALPHA;
    leftView.backgroundColor = [UIColor blackColor];
    [_scanView addSubview:leftView];
    
    /******************中间扫描区域****************************/
    UIView *scanCropView = [[UIView alloc] initWithFrame:CGRectMake(SCANVIEW_EdgeLeft,SCANVIEW_EdgeTop, rect.size.width-2*SCANVIEW_EdgeLeft,rect.size.width-2*SCANVIEW_EdgeLeft)];
    ...
    //右侧的view
    UIView *rightView = [[UIView alloc] initWithFrame:CGRectMake(rect.size.width-SCANVIEW_EdgeLeft,SCANVIEW_EdgeTop, SCANVIEW_EdgeLeft,rect.size.width-2*SCANVIEW_EdgeLeft)];
    ...
    //底部view
    UIView *downView = [[UIView alloc] initWithFrame:CGRectMake(0,rect.size.width-2*SCANVIEW_EdgeLeft+SCANVIEW_EdgeTop,rect.size.width, rect.size.height-(rect.size.width-2*SCANVIEW_EdgeLeft+SCANVIEW_EdgeTop))];
    ...
    labIntroudction.frame = CGRectMake(0,5, rect.size.width,20);
    ...
    //画中间的基准线
    _QrCodeline = [[UIView alloc] initWithFrame:CGRectMake(SCANVIEW_EdgeLeft,SCANVIEW_EdgeTop, rect.size.width-2*SCANVIEW_EdgeLeft,2)];
...
- (void)moveUpAndDownLine
{
    ...
    if (rect.size.width-2*SCANVIEW_EdgeLeft+SCANVIEW_EdgeTop == Y)
    {
        
        [UIView beginAnimations:@"moveUpAndDownLine" context:nil];
        [UIView setAnimationDuration:1];
        _QrCodeline.frame=CGRectMake(SCANVIEW_EdgeLeft, SCANVIEW_EdgeTop, rect.size.width-2*SCANVIEW_EdgeLeft,1);
    ...
    else if(SCANVIEW_EdgeTop == Y)
    {
        [UIView beginAnimations:@"moveUpAndDownLine" context:nil];
        [UIView setAnimationDuration:1];
        _QrCodeline.frame=CGRectMake(SCANVIEW_EdgeLeft, rect.size.width-2*SCANVIEW_EdgeLeft+SCANVIEW_EdgeTop, rect.size.width-2*SCANVIEW_EdgeLeft,1);
        [UIView commitAnimations];
    }

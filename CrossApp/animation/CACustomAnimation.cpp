...
namespace CACustomAnimation
{
    ...
    void Animation::startAnimation(const CACustomAnimation::Callback& callback, const std::string& animationID, float totalTime, float interval, float delay)
    {
    ...
    void schedule(const CACustomAnimation::Callback& callback, const std::string& animationID, float totalTime)
    {
        schedule(callback, animationID, totalTime, 0, 0.0f);
    }
    
    void schedule(const CACustomAnimation::Callback& callback, const std::string& animationID, float totalTime, float interval)
    {
        schedule(callback, animationID, totalTime, interval, 0.0f);
    }
    
    void schedule(const CACustomAnimation::Callback& callback, const std::string& animationID, float totalTime, float interval, float delay)
    {

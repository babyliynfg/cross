...
var AlertViewTest = ca.CAViewController.extend({
    ctor: function () {
        ...
        btn1.addTarget(this.alerButtonCallback, ca.CAControlEvents.TouchUpInSide);
        ...
        btn2.addTarget(this.alerButtonCallback, ca.CAControlEvents.TouchUpInSide);
        ...
        btn3.addTarget(this.alerButtonCallback, ca.CAControlEvents.TouchUpInSide);
